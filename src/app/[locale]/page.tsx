...
//               {t("title_one")} <span className="text-blue-500"> {t("title_two")} </span>?
//             </h1>
...
//             <div className="mt-4 bg-blue-50 dark:bg-blue-900/20 text-blue-500 py-2 px-4 rounded-full inline-block">
//             {t("action_label")}
//             </div>
//           </div>
//         </section>
