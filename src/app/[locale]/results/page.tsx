    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          {/* User Info Section - Changed to always use light theme */}
          ...
          {/* Risk Assessment Section - Changed to always use light theme */}
          ...
          {/* Next Steps Section - Changed to always use light theme */}
          <div className={`bg-white rounded-lg shadow-sm p-6 ${locale === "ar" ? "text-right" : ""}`}>
            ...
            {/* Newsletter Signup Form - Changed to always use light theme */}
