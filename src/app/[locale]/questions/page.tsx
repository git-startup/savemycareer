...
//             <span className="bg-blue-100 dark:bg-blue-900/30 text-blue-500 px-3 py-1 rounded-full text-sm font-medium">
...
//                           <ul className="absolute z-10 w-full bg-white dark:bg-gray-700 mt-1 border border-gray-300 dark:border-gray-600 rounded-md shadow-lg max-h-60 overflow-auto">
//                             {careerSuggestions.map((suggestion, i) => (
//                               <li 
//                                 key={i} 
//                                 className={`px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer ${locale === 'ar' ? 'text-right' : ''}`}
...
//                       />
//                       <span className={`text-gray-700 dark:text-gray-300 ${locale === 'ar' ? 'mr-3' : 'ml-3'}`}>
//                         {option}
//                       </span>
//                     </label>
//                   );
